        ...
        <section className="relative overflow-hidden">
          ...
          <div className="container relative z-10 mx-auto max-w-5xl px-6 pb-24 pt-24 lg:pt-28">
            ...
            <div className="mt-14 grid gap-5 md:grid-cols-2">
              {/* Free */}
              <div className="flex flex-col rounded-2xl border border-gold/15 bg-graphite-soft/60 p-8">
                ...
                <Button
                  variant="outline"
                  className="mt-8 h-11 w-full rounded-xl border-gold/30 text-parchment hover:bg-gold/10"
              ...
              <div className="relative flex flex-col rounded-2xl border border-gold/40 bg-graphite-soft p-8 shadow-[0_30px_90px_-40px_rgba(210,173,98,0.5)]">
                ...
                <h2 className="font-heading text-sm font-semibold uppercase tracking-[0.18em] text-gold">Pro</h2>
                <div className="mt-4 flex items-baseline gap-1">
            ...
            <p className="mt-10 text-center font-mono text-[0.7rem] uppercase tracking-[0.2em] text-gold-dim">
